...
function getDate() {
  ...
  if (date === "") {
    ...
    if (isPolindrome) {
      ...
      ouputEl.innerText =
        "you need to wait sometime becuase you may be somehow far from palindrome date....sooo we are finding that please wait";
      let intervaliId = setInterval(function () {
        count = 0;
